...
class Sound:
    def __init__(self):
        ...
        self.file_names = {
            ...
            3: "assets\sounds\\ending_lose.mp3",  # ending music when player loses
            ...
            9: pygame.mixer.Sound("assets\sounds\\ending_win.ogg"),  # ending music when player wins
        }
        self.file_names[2].set_volume(0.2)  # I want the volume of the explosion sound effect to be lowered.
    ...
    def stop_sound(self):
        if self.state_of_sound is not None:
            if self.state_of_sound in [0, 3]:
